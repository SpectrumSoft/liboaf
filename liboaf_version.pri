#
# Идентификатор сборки libOAF
#
isEmpty(BUILD_ID):BUILD_ID = "Development"

#
# Определяем текущую дату и время для упрощения последующей идентификации версии libOAF
#
win32 {
...
#
# Определяем версию libOAF в виде глобального символа
#
