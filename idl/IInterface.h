...
namespace OAF
{
	 ...
	 *    - функции и методы, упрощающие работу с интерфейсом со стороны клиентов, применимые
	 *      ко всем реализациям данного интерфейса и реализованные как встраиваемые функции.
	 *
