...
* {Diff(Operation._DELETE, "Hello"), Diff(Operation._INSERT, "Goodbye"),
*  Diff(Operation._EQUAL, " world.")}
* which means: delete "Hello", add "Goodbye" and keep " world."
*/
enum Operation {
  _DELETE, _INSERT, _EQUAL
};
...
*/
class OAFSTD_EXPORT Diff {
 public:
  Operation operation;
  // One of: _INSERT, _DELETE or _EQUAL.
  QString text;
 ...
 */
class OAFSTD_EXPORT diff_match_patch {
