...
{
	giterr_set(GITERR_INVALID, QT_TRANSLATE_NOOP("libgit2", "Note could not be found"));
	...
	int current_error)
{
	...
	giterr_set(GITERR_REPOSITORY, QT_TRANSLATE_NOOP("libgit2", "Object '%s' has no note"), annotated_object_sha);
	...
	int current_error)
{
	...
	giterr_set(GITERR_REPOSITORY, QT_TRANSLATE_NOOP("libgit2", "Note for '%s' exists already"), annotated_object_sha);
	return current_error;
}
