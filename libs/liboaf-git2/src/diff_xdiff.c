...
fail:
	giterr_set(GITERR_INVALID, QT_TRANSLATE_NOOP("libgit2", "Malformed hunk header from xdiff"));
	return -1;
}
	...
	size_t content_len)
{
	...
	case GIT_DIFF_LINE_CONTEXT_EOFNL:
		...
		break;
	default:
		giterr_set(GITERR_INVALID, QT_TRANSLATE_NOOP("libgit2", "Unknown diff line origin %02x"),
